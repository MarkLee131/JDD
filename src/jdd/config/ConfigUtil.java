...
//        String javaHome = "/Library/Java/JavaVirtualMachines/jdk1.7.0_21.jdk/Contents/Home/jre";
    ...
    public static void loadConfig(String filePath){
        try{
            ...
            BasicDataContainer.preDynamicProxyFragmentLimit = Integer.parseInt(configProperties.getProperty(ConfigurationEnum.PRE_DYNAMIC_PROXY_FRAGMENT_LIMIT.toString(), "1"));
